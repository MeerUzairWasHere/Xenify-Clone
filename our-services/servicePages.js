...
async function generateCat() {
  try {
    const data = await fetchData("../../our-services/servicepagesJson/catagories.json");
    const catHTML = data
      .map((cat) => {
        return ` <li>
...
async function generateNavlinks(mainNavData, subNavData) {
  try {
    const subNavResponse = await fetchData("../../our-services/servicepagesJson/sub-nav.json");
...
async function fetchCardData() {
  try {
    const response = await fetchData("../../our-services/servicepagesJson/cards.json");
    return response;
  } catch (error) {
...
(async () => {
  await generateCat();
  const mainNavResponse = await fetchData("../../our-services/servicepagesJson/main-nav.json");
